...
def InfidelityOperator(
    ...
    *,
    ...
    the function :class:`nqs_support_core.infidelity.InfidelityUPsi` .
    ...
    The drivers such as :class:`~nqs_support_core.driver.InfidelityOptimizer` and similar all use the default
    value :math:`1/2`.
        ...
        if isinstance(U_dagger, Adjoint):
            ...
            if isinstance(U_dagger, Adjoint):
                raise TypeError(
                    ...
                    "use operators coming from `nqs_support_core`. "
                )
