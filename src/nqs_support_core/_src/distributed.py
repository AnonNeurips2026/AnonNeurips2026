...
def process_index() -> int:
    ...
    :func:`nqs_support_core.distributed.process_count`.
    """
...
def shard_replicated(array, *, axis=0):
    ...
    :func:`nqs_support_core.distributed.broadcast`, :func:`nqs_support_core.distributed.allgather` or
...
def allgather(array, *, axis: int = 0, token=None):
    ...
    the first axis, which will be :ref:`nqs_support_core.distributed.process_count`
    times longer.
...
def replicate_sharding():
    ...
    Local copy to avoid nqs_support_core dependency.
    """
