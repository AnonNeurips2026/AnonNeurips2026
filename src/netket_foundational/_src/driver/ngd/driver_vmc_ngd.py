...
from netket_foundational._src.driver.ngd.sr_srt_common import sr, srt
from netket_foundational._src.driver.ngd.srt_onthefly import srt_onthefly
...
class VMC_NG(AbstractNGDDriver):
    ...
    def _prepare_derivatives(self) -> DerivativesArgs:
        ...
        """
        log_prob_p_fun, variables_p = self.state._apply_fun, self.state.variables
    ...
    ## Overridden functions from NGD, as some things differ...
    ...
    def compute_loss_and_update(self):
        ...
        afun, variables, samples, _, extra_args = self._prepare_derivatives()
