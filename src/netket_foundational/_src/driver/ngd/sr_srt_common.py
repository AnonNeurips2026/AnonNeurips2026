...
def _prepare_input(
    ...
    *,
    ...
    O_L = O_L.reshape((n_replicas, N_mc // n_replicas,) + O_L.shape[1:])
...
def _sr_srt_common(
    ...
    *,
    ...
    O_L, dv = _prepare_input(jacobians, local_grad, mode=mode, n_replicas=n_replicas)
