...
from nqs_support_core.distributed import replicate_sharding, sharding_along_axis
from netket import config
from netket.sampler import Sampler, SamplerState, MetropolisSampler, rules, ParallelTemperingSampler
...
from netket_foundational._src.operator.parametrized import (
    ParametrizedOperator,
)  # noqa: F401

from netket_foundational._src.hilbert.parameter_space import ParameterSpace
from netket_foundational._src.nn.instance_wrapper import FoundationalInstance
...
def wrap_sampler(sampler, parameter_space, joint_space):
    ...
    # Altrimenti, comportamento standard (Metropolis classico)
        ...
        raise NotImplementedError("Il wrap_sampler supporta solo Metropolis o ParallelTemperingSampler.")
...
# EXTRA
from nqs_support_core.monkeypatch import (  # noqa: E402
    add_method,
    attach_method,
    attach_property,
)
from nqs_support_core._src.monkeypatch import mcstate_sampling  # noqa: E402
...
from netket_foundational._src.vqs import serialize as serialize  # noqa: E402
