...
from nqs_support_core._src.operator.jax_utils import to_jax_operator
...
class InfidelityOptimizerNG(AbstractNGDDriver):
    ...
    .. note::
        ...
        The algorithm implemented here follows the preprint
    ...
    .. warning::
        ...
        use any driver in ``nqs_support_core``.
