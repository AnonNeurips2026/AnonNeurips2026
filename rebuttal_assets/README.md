...
- `energy_vs_budget_br2500.{png,pdf}` — shared trajectory and the three
  continuations vs cumulative budget (one MS-SR step = 4 units), with
  high-precision final-state energy evaluations at equal budget (markers).
